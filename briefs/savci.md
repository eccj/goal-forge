...
- Bulgu yoksa hedef için "dayanaklı bulgu yok" yaz. İçerik-saldırısı yap, üslup-saldırısı değil.
- Dönüş: ≤40 satır özet (S#-listesi); tam gerekçeler goals/verdicts/<koşu>-savci.md.
- SON-SATIR İSTİSNASI (savcıya özel; _ortak'ın APPROVE/REJECT-formatı JÜRİ içindir): senin son satırın: "SAVCI: <N> bulgu (S1..SN) — <en güçlü çapan>". Hüküm/confidence VERME.
