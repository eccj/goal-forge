...
| 7 | **Independence from user** | Zero items blocked on user decisions; leftovers moved to "decide before launching" | "user will explain X later" inside the goal |
