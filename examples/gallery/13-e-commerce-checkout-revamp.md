...
ASSUMPTION: on ambiguity assume reasonably + list in report; never wait on the user — EXCEPT a §RED-HOLD irreversible action (prod promotion): name it, ledger a HELD entry, STOP once.
