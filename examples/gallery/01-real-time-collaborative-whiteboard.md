...
ASSUMPTION: on ambiguity assume + list it; never wait — EXCEPT a §DAL-C irreversible action (prod domain/DB delete, publish): name it, ledger HELD, STOP once.
