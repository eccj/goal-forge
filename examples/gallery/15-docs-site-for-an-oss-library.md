...
ASSUMPTION: on ambiguity assume + list it; never wait on the user — EXCEPT a §DAL-C irreversible action (prod deploy/Pages push): name it, ledger a HELD entry, STOP once.
