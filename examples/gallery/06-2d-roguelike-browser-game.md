...
ASSUMPTION: on ambiguity assume + list it; never wait — EXCEPT a §DAL-C irreversible action (publish to a host): name it, ledger a HELD entry, STOP once.
