...
ASSUMPTION: on ambiguity assume + list it in the report, never wait on the user — EXCEPT a §RED-HOLD irreversible action (name it, ledger a HELD entry, STOP once).
