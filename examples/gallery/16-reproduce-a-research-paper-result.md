...
ASSUMPTION: make reasonable assumptions, list them in the report, never wait on the user — EXCEPT a §DAL-C irreversible action (name it, ledger a HELD entry, STOP once).
